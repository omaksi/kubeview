...
public struct ViewModeToggle: View {
    @Binding var mode: ViewMode

    public init(mode: Binding<ViewMode>) {
        self._mode = mode
    }
...
public struct ViewHeader<Trailing: View>: View {
    let count: Int
    let label: String
    let trailing: Trailing

    public init(count: Int, label: String = "items", @ViewBuilder trailing: () -> Trailing) {
        self.count = count
        self.label = label
...
public struct LoadingPlaceholder: View {
    ...
    public init(label: String, activity: String? = nil, activitySince: Date? = nil) {
        self.label = label
