...
public actor KubectlService {
    ...
    public nonisolated func run(_ args: [String], timeout: TimeInterval = 15) async throws -> Data {
        var args = args
    ...
    public func currentContext() async throws -> String {
    ...
    public func contexts() async throws -> [KubeContext] {
    ...
    public func pods(namespace: String? = nil, allNamespaces: Bool = true) async throws -> [Pod] {
    ...
    public func allEvents(warningsOnly: Bool = false) async throws -> [KubeEvent] {
    ...
    public func logs(namespace: String, pod: String, container: String?,
    ...
    public func describe(namespace: String, pod: String) async throws -> String {
        try await describe(kind: "pod", name: pod, namespace: namespace)
    }

    public func describe(kind: String, name: String, namespace: String?) async throws -> String {
    ...
    public func events(namespace: String, podName: String) async throws -> [KubeEvent] {
    ...
    public func nodeMetrics() async -> [NodeMetrics]? {
    ...
    public func podMetrics() async -> [PodMetrics]? {
