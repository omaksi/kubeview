...
public enum ResourceParser {
    ...
    public static func cpuToMillicores(_ s: String) -> Double {
    ...
    public static func memoryToBytes(_ s: String) -> Double {
        guard !s.isEmpty else { return 0 }
    ...
    public static func formatMillicores(_ m: Double) -> String {
        if m >= 1000 { return String(format: "%.2f", m / 1000) }
        return "\(Int(m))m"
    }

    public static func formatBytes(_ b: Double) -> String {
